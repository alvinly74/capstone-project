...
user02 = User.create!({username: "SterlingArcher",img_url:"http://res.cloudinary.com/awwdiio/image/upload/v1445221608/SterlingArcher_bvdqp7.jpg", password_digest: "$2a$10$FGnEORVV0Z2HM0fgKz/1eOCRasTRCDX46yNmk2SFz76PKc2TdRLzO", session_token: "fn1AfGxA3NL4Vg"})
user03 = User.create!({username: "LanaKane",img_url:"http://res.cloudinary.com/awwdiio/image/upload/v1445221609/Lana_Kane_h6eyqt.jpg", password_digest: "$2a$10$FGnEORVV0Z2HM0fgKz/1eOCRasTRCDX46yNmk2SFz76PKc2TdRLzO", session_token: "f1xqDwYIdv2L4Vg"})
...
song03 = Song.create!({title: "I'm Not Gonna Teach Your Boyfriend How to Dance", img_url:"http://res.cloudinary.com/awwdiio/image/upload/v1445222870/I_m_not_gonna_teach_him_how_to_dance_zvxxew.jpg", url: "http://res.cloudinary.com/awwdiio/video/upload/v1444866572/Black_Kids_-_I_m_Not_Gonna_Teach_Your_Boyfriend_How_To_Dance_Twelves_Remix_ypyjuv.mp3", description: "He's got two left feet and he bites my moves", user_id: 3})
